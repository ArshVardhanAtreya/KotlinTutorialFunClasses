...
fun main(args: Array<String>) {
    ...
    val value2 =
        map["key2"]                                    // Returns null because "key2" is not in the map.

    val value3: Int =
        map.getValue("key")                  // Returns 42 because it's the value corresponding to the key "key".

    val mapWithDefault = map.withDefault { k -> k.length }
    val value4 =
        mapWithDefault.getValue("key2")           // Returns the default value because "key2" is absent. For this key it's 4.
